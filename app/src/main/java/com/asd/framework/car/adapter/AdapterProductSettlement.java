...
public class AdapterProductSettlement extends ArrayAdapter {


    private Context mContext;
    private List<ProductCar> productList;

    public AdapterProductSettlement(Context context, List<ProductCar> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_settlement, parent, false);
